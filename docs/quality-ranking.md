...
| 214 | `cuopt-user-rules` | science | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 215 | `design-explore` | research | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 216 | `duckduckgo-search` | browser | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 217 | `ffmpeg-audio-processing` | video | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 218 | `frontend-to-backend-requirements` | frontend | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 219 | `himalaya` | comms | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 220 | `huggingface-tokenizers` | research | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 221 | `k6-load-testing` | devops | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 222 | `local-lipsync-pipeline` | svg-and-design | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 223 | `makepad-2-0-layout` | frontend | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 224 | `neon-object-storage` | data-databases | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 225 | `netlify-functions` | content | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 226 | `nextjs-seo-indexing` | browser | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 227 | `polars` | python-backend | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 228 | `rclone-cli` | ai-ml | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 229 | `react-i18next` | frontend | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 230 | `robius-app-architecture` | architecture | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 231 | `schema-markup-generator` | frontend | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 232 | `spark-optimization` | data-databases | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 233 | `suricata-offline-evejson` | networking | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 234 | `tanstack-query-expert` | frontend | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 235 | `the-honoured-one` | testing-qa | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 236 | `trend-analysis` | data-databases | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 237 | `trpc-fullstack` | frontend | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 238 | `vercel-ai-sdk-expert` | frontend | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 239 | `vibe-code-cleanup` | defensive-security | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 240 | `vllm` | ai-ml | 94.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 241 | `apify-actorization` | devops | 93.8 | 91.1 | A | QUALITY_KEEP | untested | — |
| 242 | `assets-pipeline` | automation | 93.8 | 91.1 | A | QUALITY_KEEP | untested | — |
| 243 | `claude-code` | agents | 93.8 | 91.1 | A | QUALITY_KEEP | untested | — |
| 244 | `component-view` | frontend | 93.8 | 91.1 | A | QUALITY_KEEP | untested | — |
| 245 | `create-branch` | observability | 93.8 | 91.1 | A | QUALITY_KEEP | untested | — |
| 246 | `crit` | frontend | 93.8 | 91.1 | A | QUALITY_KEEP | untested | — |
| 247 | `excitation-signal-design` | research | 93.8 | 91.1 | A | QUALITY_KEEP | untested | — |
| 248 | `fast-check` | testing-qa | 93.8 | 91.1 | A | QUALITY_KEEP | untested | — |
| 249 | `minecraft-modpack-server` | game-dev | 93.8 | 91.1 | A | QUALITY_KEEP | untested | — |
| 250 | `nws-flood-thresholds` | science | 93.8 | 91.1 | A | QUALITY_KEEP | untested | — |
| 251 | `obspy-data-api` | python-backend | 93.8 | 91.1 | A | QUALITY_KEEP | untested | — |
| 252 | `plan` | comms | 93.8 | 91.1 | A | QUALITY_KEEP | untested | — |
| 253 | `python-debugpy` | python-backend | 93.8 | 91.1 | A | QUALITY_KEEP | untested | — |
| 254 | `render-workflows` | python-backend | 93.8 | 91.1 | A | QUALITY_KEEP | untested | — |
| 255 | `search-company-knowledge` | ai-ml | 93.8 | 91.1 | A | QUALITY_KEEP | untested | — |
| 256 | `systematic-debugging` | agent-os | 93.8 | 91.1 | A | QUALITY_KEEP | untested | — |
| 257 | `turborepo` | devops | 93.8 | 91.1 | A | QUALITY_KEEP | untested | — |
| 258 | `ai-sdk` | mcp-and-tools | 93.1 | 94.4 | A | QUALITY_KEEP | untested | — |
| 259 | `ffmpeg-keyframe-extraction` | video | 93.1 | 94.4 | A | QUALITY_KEEP | untested | — |
| 260 | `game-camera-system` | game-dev | 93.1 | 94.4 | A | QUALITY_KEEP | untested | — |
| 261 | `gsap-web-animations` | testing-qa | 93.1 | 94.4 | A | QUALITY_KEEP | untested | — |
| 262 | `paywall-upgrade-cro` | ecommerce | 93.1 | 94.4 | A | QUALITY_KEEP | untested | — |
| 263 | `routing-subtour-elimination` | science | 93.1 | 94.4 | A | QUALITY_KEEP | untested | — |
| 264 | `3d-miniature-figurine` | image-vision | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 265 | `3d-vase-mode-art` | python-backend | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 266 | `aiq-deploy` | devops | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 267 | `automated-triage` | mcp-and-tools | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 268 | `aws-sst-development` | devops | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 269 | `build-chatgpt-app` | mcp-and-tools | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 270 | `building-ai-agent-on-cloudflare` | devops | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 271 | `chatgpt-apps` | mcp-and-tools | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 272 | `claude-automation-recommender` | mcp-and-tools | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 273 | `claude-design` | frontend | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 274 | `color-blocking` | image-vision | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 275 | `comfyui-prompt-engineer` | video | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 276 | `community-evals` | python-backend | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 277 | `debugging-and-error-recovery` | testing-qa | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 278 | `designing-workflow-skills` | automation | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 279 | `developer-advocacy` | research | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 280 | `end-to-end-research` | agent-os | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 281 | `finite-horizon-lqr` | ai-ml | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 282 | `game-godot-genre-party` | godot-extra | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 283 | `game-godot-genre-racing` | godot-extra | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 284 | `game-godot-genre-romance` | godot-extra | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 285 | `game-godot-genre-shooter` | godot-extra | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 286 | `game-godot-genre-sports` | godot-extra | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 287 | `game-hud-system` | game-dev | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 288 | `gemini-workspace` | comms | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 289 | `google-search-ai-mode` | research | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 290 | `google-vids` | video | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 291 | `hugging-face-cli` | research | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 292 | `hugging-face-dataset-viewer` | ai-ml | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 293 | `hugging-face-evaluation` | ai-ml | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 294 | `llm-wiki` | ai-ml | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 295 | `manim-video` | video | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 296 | `mesh-memory` | data-databases | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 297 | `monochromatic-ui` | ai-ml | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 298 | `monopoly` | data-databases | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 299 | `motion` | frontend | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 300 | `nlp-research-repo-packaging` | research | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 301 | `obsidian` | agent-os | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 302 | `planning-and-task-breakdown` | product | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 303 | `postgresql-cli` | data-databases | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 304 | `pymol` | science | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 305 | `react-ink` | frontend | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 306 | `redis-cli` | data-databases | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 307 | `review-animations` | frontend | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 308 | `setup-metabase-instance` | python-backend | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 309 | `setup-tailwind-typescript` | frontend | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 310 | `siyuan` | frontend | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 311 | `skill-development` | mcp-and-tools | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 312 | `snowflake-development` | defensive-security | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 313 | `spatial-design` | image-vision | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 314 | `state-space-linearization` | science | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 315 | `svg-creator` | svg-and-design | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 316 | `svg-vault-embeddings` | ai-ml | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 317 | `swiftui-wcag-accessibility-auditor` | frontend | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 318 | `trigger-dev` | automation | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 319 | `ui-polish` | frontend | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 320 | `valtio` | frontend | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 321 | `video-prompt-engineering-2026` | video | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 322 | `voice-ai-development` | video | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 323 | `webgl-performance-tuning` | threejs | 93.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 324 | `3d-web-experience` | frontend | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 325 | `apify-actor-development` | ai-ml | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 326 | `astropy` | research | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 327 | `bento-ui` | data-databases | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 328 | `client-view` | comms | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 329 | `comfyui-prompt-interview` | video | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 330 | `conductor-revert` | git-github | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 331 | `contract-playbook-review` | image-vision | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 332 | `custom-distance-metrics` | data-databases | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 333 | `data-reconciliation` | ai-ml | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 334 | `design-research` | research | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 335 | `diagnosing-bugs` | automation | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 336 | `documentation-and-adrs` | content | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 337 | `fp-errors` | testing-qa | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 338 | `game-assets-pipeline` | game-dev | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 339 | `gen-catalog` | frontend | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 340 | `github-issue-creator` | git-github | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 341 | `godot-4-migration` | godot-extra | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 342 | `hasdata` | frontend | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 343 | `lego-brick-game-dev` | game-dev | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 344 | `logistics-rules-to-optimization` | localization | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 345 | `magicui` | frontend | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 346 | `netlify-deploy` | devops | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 347 | `obspy-datacenter-client` | networking | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 348 | `odoo-inventory-optimizer` | data-databases | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 349 | `output-validation` | testing-qa | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 350 | `output-voice-friendly-short` | research | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 351 | `python-scala-idioms` | python-backend | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 352 | `python-scala-oop` | python-backend | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 353 | `seaborn` | python-backend | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 354 | `simulation-metrics` | data-databases | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 355 | `speaker-clustering` | ai-ml | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 356 | `svgo` | svg-and-design | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 357 | `telegram-bot-builder` | comms | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 358 | `testng-skill` | python-backend | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 359 | `three-js-web-game` | svg-and-design | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 360 | `threejs-skills` | threejs | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 361 | `vibe-code-auditor` | defensive-security | 92.2 | 88.9 | A- | QUALITY_KEEP | untested | — |
| 362 | `pdf` | research | 91.5 | 92.2 | A | QUALITY_KEEP | untested | — |
| 363 | `2slides-ppt-generator` | docs-knowledge | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 364 | `agent-tool-builder` | ai-ml | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 365 | `api-integration` | comms | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 366 | `audio-extractor` | video | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 367 | `automatic-speech-recognition` | video | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 368 | `cache-policy-comparison` | ai-ml | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 369 | `carrier-relationship-management` | finance | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 370 | `competitor-tracking` | game-dev | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 371 | `creative-prompt-engineering` | video | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 372 | `customs-trade-compliance` | content | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 373 | `cvss-score-extraction` | defensive-security | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 374 | `dashboards-and-real-time-visualization` | data-databases | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 375 | `deployment-validation-config-validate` | devops | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 376 | `design-harden` | defensive-security | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 377 | `developer-onboarding` | product | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 378 | `flash-attention` | docs-knowledge | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 379 | `game-console-porting-certification` | game-dev | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 380 | `game-creativity-director` | game-dev | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 381 | `game-csharp-godot` | godot | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 382 | `github-presence` | git-github | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 383 | `gitops-workflow` | devops | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 384 | `godot-inventory-system` | godot-extra | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 385 | `hubspot-integration` | python-backend | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 386 | `interactive-portfolio` | finance | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 387 | `inventory-demand-planning` | finance | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 388 | `ios-design-guidelines` | mobile | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 389 | `mailtrap-sending-emails` | comms | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 390 | `multi-agent-architect` | ai-ml | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 391 | `neon-functions` | devops | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 392 | `parallel-plan` | ai-ml | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 393 | `performance-and-web-vitals` | video | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 394 | `pinecone` | ai-ml | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 395 | `postman-newman-automation` | devops | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 396 | `pr-merge-champion` | git-github | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 397 | `product-feedback-synthesizer` | product | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 398 | `review-ux-ui` | ai-ml | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 399 | `saga-orchestration` | automation | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 400 | `semgrep-rule-variant-creator` | defensive-security | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 401 | `slack` | comms | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 402 | `slack-outgoing-message` | comms | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 403 | `startup-canvas` | data-databases | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 404 | `technical-art-vfx` | automation | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 405 | `technical-diagram-expert` | devops | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 406 | `test-fixing` | devops | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 407 | `ui-ux-product-craft` | agents | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 408 | `usability-testing` | testing-qa | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 409 | `vercel-deployment` | devops | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 410 | `voice-activity-detection` | video | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 411 | `workload-balancing` | networking | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 412 | `yaml-config` | content | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 413 | `zapier-make-patterns` | content | 91.5 | 87.8 | A- | QUALITY_KEEP | untested | — |
| 414 | `convex` | python-backend | 90.8 | 91.1 | A | QUALITY_KEEP | untested | — |
| 415 | `qutip` | python-backend | 90.8 | 91.1 | A | QUALITY_KEEP | untested | — |
| 416 | `bulletmind` | content | 90.7 | 86.7 | A- | QUALITY_KEEP | untested | — |
| 417 | `ci-cd-and-automation` | devops | 90.7 | 86.7 | A- | QUALITY_KEEP | untested | — |
| 418 | `code-showcase-testing-patterns` | testing-qa | 90.7 | 86.7 | A- | QUALITY_KEEP | untested | — |
| 419 | `consistent-character-builder` | auth | 90.7 | 86.7 | A- | QUALITY_KEEP | untested | — |
| 420 | `consistent-characters-2026` | auth | 90.7 | 86.7 | A- | QUALITY_KEEP | untested | — |
| 421 | `deal-analysis` | testing-qa | 90.7 | 86.7 | A- | QUALITY_KEEP | untested | — |
| 422 | `drizzle-migration-conflict` | data-databases | 90.7 | 86.7 | A- | QUALITY_KEEP | untested | — |
| 423 | `fail2ban` | defensive-security | 90.7 | 86.7 | A- | QUALITY_KEEP | untested | — |
| 424 | `godot-game-loop-waves` | godot-extra | 90.7 | 86.7 | A- | QUALITY_KEEP | untested | — |
| 425 | `internationalization` | localization | 90.7 | 86.7 | A- | QUALITY_KEEP | untested | — |
| 426 | `ios-app-intents` | mobile | 90.7 | 86.7 | A- | QUALITY_KEEP | untested | — |
| 427 | `matplotlib` | python-backend | 90.7 | 86.7 | A- | QUALITY_KEEP | untested | — |
| 428 | `memory-systems` | testing-qa | 90.7 | 86.7 | A- | QUALITY_KEEP | untested | — |
| 429 | `odoo-qweb-templates` | docs-knowledge | 90.7 | 86.7 | A- | QUALITY_KEEP | untested | — |
| 430 | `pytest-skill` | python-backend | 90.7 | 86.7 | A- | QUALITY_KEEP | untested | — |
| 431 | `remotion-video` | video | 90.7 | 86.7 | A- | QUALITY_KEEP | untested | — |
| 432 | `silence-detector` | video | 90.7 | 86.7 | A- | QUALITY_KEEP | untested | — |
| 433 | `statsmodels` | python-backend | 90.7 | 86.7 | A- | QUALITY_KEEP | untested | — |
| 434 | `sympy` | python-backend | 90.7 | 86.7 | A- | QUALITY_KEEP | untested | — |
| 435 | `timed-lyric-transcription` | video | 90.7 | 86.7 | A- | QUALITY_KEEP | untested | — |
| 436 | `fp-async` | automation | 90.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 437 | `robot-bringup` | testing-qa | 90.0 | 90.0 | A | QUALITY_KEEP | untested | — |
| 438 | `wrangler` | devops | 90.0 | 90.0 | A | QUALITY_KEEP | untested | — |

### PQI 80–89.9 (44)

| rank | skill | tag | pqi | independent_score | independent_grade | independent_decision | works | notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 439 | `3-statement-model` | finance | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 440 | `3d-articulated-print-in-place` | python-backend | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 441 | `browser-extension-builder` | architecture | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 442 | `bug-hunter` | testing-qa | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 443 | `dotnet-backend` | python-backend | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 444 | `fp-refactor` | architecture | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 445 | `game-godot-genre-simulation` | godot-extra | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 446 | `github-actions-debugger` | git-github | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 447 | `github-pr-workflow` | agent-os | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 448 | `godot-scene-organization` | godot-extra | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 449 | `jakarta-namespace` | python-backend | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 450 | `k8s-security-policies` | defensive-security | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 451 | `media-pipeline-triage` | video | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 452 | `mobile-web-game-polish` | svg-and-design | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 453 | `motion-animation-craft` | agents | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 454 | `nosql-expert` | data-databases | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 455 | `performance-optimizer` | data-databases | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 456 | `pitch-deck-storytelling` | content | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 457 | `rdkit` | science | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 458 | `react-native-testing` | mobile | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 459 | `review-msa-deep-review` | research | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 460 | `ruby-patterns` | testing-qa | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 461 | `sankhya-dashboard-html-jsp-custom-best-pratices` | data-databases | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
| 462 | `snyk` | defensive-security | 89.9 | 85.6 | A- | QUALITY_KEEP | untested | — |
