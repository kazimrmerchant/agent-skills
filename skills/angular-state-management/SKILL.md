...
- NgRx packages installed if using NgRx Store, ComponentStore, or SignalStore:
  ```powershell
  npm install @ngrx/store @ngrx/effects @ngrx/component-store @ngrx/signals
  ```
- Basic understanding of RxJS and Angular dependency injection (`inject()`)
