...
> **Not for 3D printing.** This file is Manim scene camera / `ThreeDScene` only.
> For printable STL/3MF, FDM CAD, Meshy, or Bambu workflows use personal skills:
> `~/.cursor/skills/3d-print-master`, `parametric-fdm-cad`, `meshy-3d`, `mesh-print-validate`.
